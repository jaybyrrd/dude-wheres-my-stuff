...
public interface DudeWheresMyStuffConfig extends Config {
  ...
  @ConfigItem(
      ...
      section = DATA_EXPORT_OPTIONS,
      position = 0,
      description = "This will determine whether you write to a CSV or a Google Spreadsheet")
  default DataDestination writeDestination() {
    return DataDestination.CSV;
  }
  ...
  @ConfigItem(
      ...
      section = DATA_EXPORT_OPTIONS,
      position = 101,
      description = "Google spreadsheet ID must be provided in order to sync to Google sheets")
  default String googleSpreadSheetId() {
    return "";
  }

  @ConfigItem(
      keyName = "googleSheetsEmail",
      name = "Google Spreadsheet Email",
      section = DATA_EXPORT_OPTIONS,
      position = 100,
      description = "Google Spreadsheet Email must be provided in order to sync to Google sheets")
  default String googleSheetsEmail() {
    return "";
  }
